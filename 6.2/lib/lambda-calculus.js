(function() {
  ...
  var Grammar = {
    __consume__expression: function(input) {
      ...
      address0 = this.__consume__calls();
      if (address0) {
      } else {
        this._offset = index1;
        ...
        if (address0) {
          ...
          this._offset = index1;
          address0 = this.__consume__function();
          if (address0) {
          } else {
            this._offset = index1;
          }
    ...
    __consume__calls: function(input) {
      var address0 = null, index0 = this._offset;
      this._nodeCache["calls"] = this._nodeCache["calls"] || {};
      var cached = this._nodeCache["calls"][index0];
      if (cached) {
        this._offset += cached.textValue.length;
        return cached;
      }
      ...
      address1 = this.__consume__variable();
      if (address1) {
      } else {
        this._offset = index2;
        address1 = this.__consume__function();
        if (address1) {
        } else {
          this._offset = index2;
        }
      ...
      if (elements0) {
        ...
        var type4 = find(this.constructor, "CallsNode");
      ...
      return this._nodeCache["calls"][index0] = address0;
    },
    ...
    __consume__function: function(input) {
      var address0 = null, index0 = this._offset;
      this._nodeCache["function"] = this._nodeCache["function"] || {};
      var cached = this._nodeCache["function"][index0];
      if (cached) {
        this._offset += cached.textValue.length;
        return cached;
      }
      ...
      if (address1) {
        ...
        if (address2) {
          elements0.push(address2);
          text0 += address2.textValue;
          labelled0.parameter = address2;
          var address4 = null;
          var slice4 = null;
          if (this._input.length > this._offset) {
            slice4 = this._input.substring(this._offset, this._offset + 3);
          } else {
            slice4 = null;
          }
          if (slice4 === " { ") {
      ...
      if (elements0) {
        ...
        var type5 = find(this.constructor, "FunctionNode");
      ...
      return this._nodeCache["function"][index0] = address0;
    }
  };
  ...
  Parser.prototype.parse = function() {
    var result = this.__consume__expression();
  ...
  if (typeof require === "function" && typeof exports === "object") {
    ...
    var namespace = this;
    LambdaCalculus = Grammar;
    LambdaCalculusParser = Parser;
    LambdaCalculusParser.formatError = formatError;
  }
})();
